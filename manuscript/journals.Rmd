---
title: 'Journals: Random Words with Random Data^[Preliminary Draft]'
author: "Jane Doe^[Department of Science]"
...
library(stargazer)
#data
df_raw <- read.csv("/Users/suyi/Documents/suyi-rmd/data/journals.csv")
```

```{r, data}
df <- df_raw %>% mutate(subfield = as.factor(subfield),
...
Department of Science, University of Random. Email: <jane.doe@random.edu>. Website: [www.janedoe.com](https://www.janedoe.com).
...
+----------------+------+--------------+-------------------+
|Delgado & Perry | 2010 | Descriptve   | Journal of Route  |
+----------------+------+--------------+-------------------+
...
ggplot(data = df, mapping = aes(x = h5_median, y = h5_index)) +
         geom_point() + facet_wrap(.~branch) +
         scale_color_discrete(name = "Journal Type") +
         theme_bw() +
